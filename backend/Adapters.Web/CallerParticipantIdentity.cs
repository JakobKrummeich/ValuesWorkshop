...
internal static class CallerParticipantIdentity
{
    ...
    internal static ParticipantId ParticipantIdOf(HubCallerContext context)
    {
        var subject =
    ...
    internal static ParticipantId ForSubject(string subject)
    {
        var digest = SHA256.HashData(
            Encoding.UTF8.GetBytes(ParticipantIdentityNamespace + subject)
        );
