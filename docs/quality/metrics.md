...
| --- | --- |
| commit | `6869a54` — The report writes the README's diagram regions before it measures, because the measurement runs the drift gate that compares them |
| committed | 2026-09-05T11:02:31+00:00 |
| report generated | 2026-09-05T11:02:33.376Z |
...
| --- | ---: | ---: | ---: | ---: |
| backend | 354 | 8,876 | 19,807 | 28,683 |
...
| scripts | 141 | 7,517 | 4,444 | 11,961 |
| tasks | 59 | 10,447 | 0 | 10,447 |
| **repository** | **1,195** | **54,024** | **44,807** | **98,831** |
...
| --- | ---: | ---: | ---: | ---: |
| jest — frontend units, hooks and components | 1,356 | 92.46% | at least 80% | 90.04% |
| xunit — backend domain, application, adapters and host | 950 | 98.6% | at least 80% | 93.1% |
| Playwright — end to end through the browser | 93 | — | — | — |
| **total** | **2,399** |  |  |  |

Coverage is measured over 3,215 of 3,477 frontend lines and 9,974 of 10,106 backend lines. The end-to-end suite is listed, never run, by this report.
...
| functions measured | 3,783 | 1,795 |
...
- `git ls-files`
- `git log --numstat --no-renames --format=%H 6869a546efc284fc0b0f0716b21aeb117f3e42ea`
...
425 production code files were ranked over 849 commits.
...
The frontend and backend scores were measured at `800a926` and `ce36bb8`, not at `6869a54` — the commit this report describes — so they describe the code as it stood then.
...
- `git rev-list --count 6869a546efc284fc0b0f0716b21aeb117f3e42ea`
- `git rev-list --count "--grep=^Merge pull request" 6869a546efc284fc0b0f0716b21aeb117f3e42ea`
- `git log --max-parents=0 --format=%cI 6869a546efc284fc0b0f0716b21aeb117f3e42ea`
- `git shortlog --summary --numbered 6869a546efc284fc0b0f0716b21aeb117f3e42ea`
