export enum MessageKey {
  ...
  AdvanceGuardJoin = "facilitator.advanceGuard.join",
  AdvanceGuardQuiz = "facilitator.advanceGuard.quiz",
  AdvanceGuardSelection = "facilitator.advanceGuard.selection",
  AdvanceGuardGroupFormation = "facilitator.advanceGuard.groupFormation",
  AdvanceGuardGroupWork = "facilitator.advanceGuard.groupWork",
  AdvanceGuardValuePresentation = "facilitator.advanceGuard.valuePresentation",
  AdvanceGuardFinalVoting = "facilitator.advanceGuard.finalVoting",
  SessionCodeLabel = "session.codeLabel",
  ...
  FinalVotingVoteLeftSingle = "finalVoting.voteLeftSingle",
